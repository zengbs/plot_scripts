...
field       = 'number_density'    # to change the target field, one must modify set_unit() accordingly
center_mode = 'c'
dpi         = 150
...
# add new derived field
   ds.add_field( ("gamer", "number_density")     , function=_number_density  , sampling_type="cell", units="1/code_length**3" )
