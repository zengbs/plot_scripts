...
parser.add_argument( '-f', action='store', required=True,  type=int, dest='field',
                     help='field you want to plot' )
parser.add_argument( '-t', action='store', required=True,  type=int, dest='time',
                     help='field you want to plot' )
parser.add_argument( '-x', action='store', required=True,  type=int, dest='x_range',
                     help='field you want to plot' )
parser.add_argument( '-p', action='store', required=True,  type=int, dest='cut_plane',
                     help='plane you want to cut' )
parser.add_argument( '-st', action='store', required=True,  type=int, dest='idx_start',
                     help='first data index' )
parser.add_argument( '-et', action='store', required=True,  type=int, dest='idx_end',
                     help='last data index' )
parser.add_argument( '-dt', action='store', required=False, type=int, dest='didx',
